...
" Hashes (#)
inoremap ,,, <Home><C-R>=f_init#addLine("#")<C-M><CR>
nmap ,,, o,,,

" Stars (*)
inoremap ,,. <Home><Space><Space><C-R>=f_init#addLine("*")<C-M><CR>
nmap ,,. o,,.

inoremap ,,8 <Home>/*<Space><C-R>=f_init#addLine("*")<C-M><CR>
nmap ,.. o,..
